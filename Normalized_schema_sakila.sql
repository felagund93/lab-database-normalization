...
-- -----------------------------------------------------
-- Table `mydb`.`rental_tier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`rental_tier` (
  `rental_rating_id` INT NOT NULL AUTO_INCREMENT,
  `tier` VARCHAR(45) NOT NULL,
  `rate_eur` DECIMAL(4,2) NOT NULL,
  PRIMARY KEY (`rental_rating_id`),
  UNIQUE INDEX `tier_UNIQUE` (`tier` ASC) VISIBLE,
  UNIQUE INDEX `rental_rating_id_UNIQUE` (`rental_rating_id` ASC) VISIBLE)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `mydb`.`replacement_costs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`replacement_costs` (
  `replacement_id` INT NOT NULL AUTO_INCREMENT,
  `category` VARCHAR(45) NOT NULL,
  `cost` DECIMAL(5,2) NOT NULL,
  PRIMARY KEY (`replacement_id`),
  UNIQUE INDEX `replacement_id_UNIQUE` (`replacement_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `sakila`.`film` (
  ...
  `rental_tier_id` TINYINT UNSIGNED NOT NULL,
  `replacement_costs_id` INT NOT NULL,
  ...
  INDEX `fk_film_rental_rating1_idx` (`rental_tier_id` ASC) VISIBLE,
  INDEX `fk_film_replacement_costs1_idx` (`replacement_costs_id` ASC) VISIBLE,
  CONSTRAINT `fk_film_language_original`
    FOREIGN KEY (`original_language_id`)
    REFERENCES `sakila`.`language` (`language_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_film_rental_rating1`
    FOREIGN KEY (`rental_tier_id`)
    REFERENCES `mydb`.`rental_tier` (`rental_rating_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_film_replacement_costs1`
    FOREIGN KEY (`replacement_costs_id`)
    REFERENCES `mydb`.`replacement_costs` (`replacement_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 1001
...
-- -----------------------------------------------------
-- Table `mydb`.`film_language`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`film_language` (
  ...
  INDEX `fk_film_language_film_idx` (`film_id` ASC) VISIBLE,
  INDEX `fk_film_language_language1_idx` (`language_id` ASC) VISIBLE,
  CONSTRAINT `fk_film_language_film`
    FOREIGN KEY (`film_id`)
    REFERENCES `sakila`.`film` (`film_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_film_language_language1`
...
-- -----------------------------------------------------
-- Table `sakila`.`deleted_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`deleted_user` (
  `deleted_user_id` INT NOT NULL AUTO_INCREMENT,
  `customer_id` SMALLINT UNSIGNED NOT NULL,
  `email` TEXT NULL DEFAULT NULL,
  `last_update` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`deleted_user_id`),
  UNIQUE INDEX `deleted_user_id` (`deleted_user_id` ASC) VISIBLE,
  UNIQUE INDEX `customer_id` (`customer_id` ASC) VISIBLE,
  CONSTRAINT `deleted_user_ibfk_1`
...
-- -----------------------------------------------------
-- Table `sakila`.`rentals_june`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`rentals_june` (
  `rental_id` INT NOT NULL AUTO_INCREMENT,
  `rental_day` TINYINT NULL DEFAULT NULL,
  `rental_time` TIME NULL DEFAULT NULL,
  `inventory_id` MEDIUMINT UNSIGNED NULL DEFAULT NULL,
  `customer_id` SMALLINT UNSIGNED NULL DEFAULT NULL,
  `return_date` DATETIME NULL DEFAULT NULL,
  `staff_id` TINYINT UNSIGNED NULL DEFAULT NULL,
  `last_update` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`rental_id`),
  UNIQUE INDEX `rental_id` (`rental_id` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 3470
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
